...
class Ui_watch(object):
    def setupUi(self, watch):
        ...
        self.btn_stop.setMaximumSize(QtCore.QSize(100, 15))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        self.btn_stop.setFont(font)
        self.btn_stop.setStyleSheet(_fromUtf8("color: rgb(0, 0, 0);\n"
...
"background-color: rgb(0,0, 0);"))
        ...
        self.btn_reset.setMaximumSize(QtCore.QSize(100, 15))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        self.btn_reset.setFont(font)
        self.btn_reset.setStyleSheet(_fromUtf8("color: rgb(0, 0, 0);\n"
"background-color: rgb(0, 0, 0);"))
